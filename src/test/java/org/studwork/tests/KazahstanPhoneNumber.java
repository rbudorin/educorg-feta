...
public class KazahstanPhoneNumber {
    ...
    public KazahstanPhoneNumber(String numbers, String phoneNumber, String formattedPhoneNumber) {
    ...
    @Test
    public void verifyKazahstanPhoneNumberFormatting() {
